...
- Office and OpenDocument: DOC/DOT/DOCX/DOCM/DOTX/DOTM, RTF, PPT/PPS/POT/PPTX/PPTM/PPSX/PPSM/POTX/POTM, XLS/XLSB/XLSX/XLSM/XLTX/XLTM, ODT/ODS/ODP with paragraph, heading, Word comments/footnotes/endnotes, Word/PowerPoint/OpenDocument table row/cell metadata, slide, PresentationML shape geometry, PowerPoint speaker notes, sheet-row, cell-coordinate, SpreadsheetML formula and hyperlink metadata, and table elements for OOXML/OpenDocument payloads.
- Ebooks: EPUB.
...
- Unstructured-style element families for Markdown, markup, and structured-document headings, paragraphs, lists, links, images, table headers, table rows, code, citations, formulas, and spreadsheet hyperlinks.
