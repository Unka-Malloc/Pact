...
- XLSX extraction preserves workbook sheet name/id/state/path, header row, row number, cell reference, formula, and `header=value` pairs so table evidence can be classified and grounded without losing cell context.
