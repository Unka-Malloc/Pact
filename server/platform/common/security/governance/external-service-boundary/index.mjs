...
export const EXTERNAL_SERVICE_BOUNDARY_GOVERNANCE_ID = SECURITY_BOUNDARY_IDS.EXTERNAL_SERVICE_PACT_PLATFORM;
...
export function listExternalServiceBoundaryGovernanceControls() {
  return describeExternalServiceBoundaryGovernance().controlsByGoal;
}
