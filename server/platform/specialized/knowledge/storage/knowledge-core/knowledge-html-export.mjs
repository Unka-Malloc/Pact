export const KNOWLEDGE_HTML_EXPORT_PACKAGE_TYPE = "splitall.knowledge.html-export";
...
function suggestedFileName(filters = {}, generatedAt = new Date().toISOString()) {
  ...
  return `splitall-knowledge-${slug(scope)}-${stamp}.html`;
}
