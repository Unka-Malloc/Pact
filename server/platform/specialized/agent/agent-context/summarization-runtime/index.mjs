...
import { callAgentGateway } from "../../agent-gateway/index.mjs";
import {
  createMultiAgentCoordinator,
  DEFAULT_SUMMARIZATION_ROLES,
  MULTI_AGENT_COORDINATOR_PROTOCOL_VERSION
} from "../../agent-gateway/multi-agent-coordinator/index.mjs";
  ...
  async function startRun(input = {}) {
    const allocationResult = typeof clientRuntimeAllocator?.apply === "function"
      ? await clientRuntimeAllocator.apply(input, {
          taskType: input.taskType || "knowledge.summarization",
    ...
    const workspaceResult = agentWorkspace.createWorkspace({
