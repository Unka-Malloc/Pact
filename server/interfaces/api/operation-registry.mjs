...
const SERVER_API_OPERATION_DEFINITIONS = [
  ...
  },
  {
    ...
    cli: { command: ["mounts", "set"], usage: "mounts set --body mounts.json" },
    requiredScopes: ["runtime:admin"]
  },
  {
  ...
  {
    id: "tool_platform.get",
    feature: "tool_platform",
    label: "读取工具平台授权",
    target: { controller: "system", method: "handleGetToolPlatform" },
    http: { method: "GET", path: "/api/tool-platform", localInForwardMode: true },
    rpc: { method: "tool_platform.get" },
    cli: { command: ["tool-platform"], usage: "tool-platform" }
  },
  {
    id: "tool_platform.create_grant",
    feature: "tool_platform",
    label: "创建工具授权",
    target: { controller: "system", method: "handleCreateToolGrant" },
    http: { method: "POST", path: "/api/tool-platform/grants", localInForwardMode: true },
    rpc: { method: "tool_platform.create_grant", body: "params" },
    cli: { command: ["tool-platform", "create-grant"], usage: "tool-platform create-grant --body grant.json" }
  },
  {
    id: "tool_platform.update_grant",
    feature: "tool_platform",
    label: "更新工具授权",
    target: { controller: "system", method: "handleUpdateToolGrant" },
    http: { method: "POST", path: "/api/tool-platform/grants/:grantId", localInForwardMode: true },
    rpc: {
      method: "tool_platform.update_grant",
      body: "params",
      params: [{ name: "grantId", aliases: ["grant-id", "id"], required: true }]
    },
    cli: {
      command: ["tool-platform", "update-grant"],
      usage: "tool-platform update-grant --id GRANT_ID --body grant.json",
      pathParams: { grantId: ["grant-id", "id"] }
    }
  },
  {
    id: "tool_platform.delete_grant",
    feature: "tool_platform",
    label: "删除工具授权",
    target: { controller: "system", method: "handleDeleteToolGrant" },
    http: { method: "DELETE", path: "/api/tool-platform/grants/:grantId", localInForwardMode: true },
    rpc: {
      method: "tool_platform.delete_grant",
      params: [{ name: "grantId", aliases: ["grant-id", "id"], required: true }]
    },
    cli: {
      command: ["tool-platform", "delete-grant"],
      usage: "tool-platform delete-grant --id GRANT_ID",
      pathParams: { grantId: ["grant-id", "id"] }
    }
  },
  {
    id: "tool_platform.rotate_grant",
    feature: "tool_platform",
    label: "轮换工具授权 Token",
    target: { controller: "system", method: "handleRotateToolGrant" },
    http: { method: "POST", path: "/api/tool-platform/grants/:grantId/rotate", localInForwardMode: true },
    rpc: {
      method: "tool_platform.rotate_grant",
      params: [{ name: "grantId", aliases: ["grant-id", "id"], required: true }]
    },
    cli: {
      command: ["tool-platform", "rotate-grant"],
      usage: "tool-platform rotate-grant --id GRANT_ID",
      pathParams: { grantId: ["grant-id", "id"] }
    }
  },
  {
  ...
  },
  {
    ...
    label: "工具审计列表",
    target: { controller: "system", method: "handleToolManagementPassthrough" },
    http: { method: "GET", path: "/api/tool-management/v1/audit", localInForwardMode: true },
  ...
  },
  {
    ...
    label: "工具指标摘要",
    target: { controller: "system", method: "handleToolManagementPassthrough" },
    http: { method: "GET", path: "/api/tool-management/v1/metrics/summary", localInForwardMode: true },
  ...
  },
  {
    ...
    label: "工具事件",
    target: { controller: "system", method: "handleToolManagementPassthrough" },
    http: { method: "GET", path: "/api/tool-management/v1/events", localInForwardMode: true },
    requiredScopes: ["console:read"]
  },
  {
    id: "email_rules.get",
  ...
  {
    id: "knowledge_packages.list",
    feature: "knowledge_packages",
    label: "知识包列表",
    target: { controller: "system", method: "handleListKnowledgePackages" },
    http: { method: "GET", path: "/api/knowledge-packages" },
    rpc: { method: "knowledge_packages.list" },
    cli: { command: ["knowledge-packages", "list"], aliases: [["knowledge-packages"]], usage: "knowledge-packages list" },
    requiredScopes: ["console:read"]
  },
  {
    id: "knowledge_packages.get",
    feature: "knowledge_packages",
    label: "读取知识包",
    target: { controller: "system", method: "handleGetKnowledgePackage" },
    http: {
      method: "GET",
      path: "/api/knowledge-packages/:packageId",
      query: [{ name: "version", aliases: ["version"] }],
      coerce: { version: "number" }
    },
    rpc: {
      method: "knowledge_packages.get",
      params: [
        { name: "packageId", aliases: ["package-id", "packageId", "id"], required: true },
        { name: "version", aliases: ["version"], type: "number" }
      ]
    },
    cli: {
      command: ["knowledge-packages", "get"],
      usage: "knowledge-packages get --id PACKAGE_ID [--version N]",
      pathParams: { packageId: ["package-id", "packageId", "id"] }
    },
    requiredScopes: ["console:read"]
  },
  {
    id: "knowledge_packages.create",
    feature: "knowledge_packages",
    label: "创建知识包版本",
    target: { controller: "system", method: "handleCreateKnowledgePackage" },
    http: { method: "POST", path: "/api/knowledge-packages" },
    rpc: { method: "knowledge_packages.create", body: "params" },
    cli: { command: ["knowledge-packages", "create"], usage: "knowledge-packages create --body package.json --confirm" },
    requiredScopes: ["runtime:admin"]
  },
  {
    id: "knowledge_packages.update",
    feature: "knowledge_packages",
    label: "更新知识包版本",
    target: { controller: "system", method: "handleUpdateKnowledgePackage" },
    http: { method: "POST", path: "/api/knowledge-packages/:packageId" },
    rpc: {
      method: "knowledge_packages.update",
      body: "params",
      params: [{ name: "packageId", aliases: ["package-id", "packageId", "id"], required: true }]
    },
    cli: {
      command: ["knowledge-packages", "update"],
      usage: "knowledge-packages update --id PACKAGE_ID --body package.json --confirm",
      pathParams: { packageId: ["package-id", "packageId", "id"] }
    },
    requiredScopes: ["runtime:admin"]
  },
  {
    id: "knowledge_packages.publish",
    feature: "knowledge_packages",
    label: "发布知识包版本",
    target: { controller: "system", method: "handlePublishKnowledgePackage" },
    http: { method: "POST", path: "/api/knowledge-packages/:packageId/publish" },
    rpc: {
      method: "knowledge_packages.publish",
      body: "params",
      params: [{ name: "packageId", aliases: ["package-id", "packageId", "id"], required: true }]
    },
    cli: {
      command: ["knowledge-packages", "publish"],
      usage: "knowledge-packages publish --id PACKAGE_ID [--version N] --confirm",
      pathParams: { packageId: ["package-id", "packageId", "id"] },
      bodyParams: [{ name: "version", aliases: ["version"], type: "number" }]
    },
    requiredScopes: ["runtime:admin"]
  },
  {
    id: "knowledge_packages.rollback",
    feature: "knowledge_packages",
    label: "回滚知识包",
    target: { controller: "system", method: "handleRollbackKnowledgePackage" },
    http: { method: "POST", path: "/api/knowledge-packages/:packageId/rollback" },
    rpc: {
      method: "knowledge_packages.rollback",
      body: "params",
      params: [{ name: "packageId", aliases: ["package-id", "packageId", "id"], required: true }]
    },
    cli: {
      command: ["knowledge-packages", "rollback"],
      usage: "knowledge-packages rollback --id PACKAGE_ID --version N --confirm",
      pathParams: { packageId: ["package-id", "packageId", "id"] },
      bodyParams: [{ name: "version", aliases: ["version", "target-version", "targetVersion"], type: "number", required: true }]
    },
    requiredScopes: ["runtime:admin"]
  },
  {
    id: "knowledge_packages.export",
    feature: "knowledge_packages",
    label: "导出知识包",
    target: { controller: "system", method: "handleExportKnowledgePackage" },
    http: {
      method: "GET",
      path: "/api/knowledge-packages/:packageId/export",
      query: [{ name: "version", aliases: ["version"] }],
      coerce: { version: "number" }
    },
    rpc: {
      method: "knowledge_packages.export",
      params: [
        { name: "packageId", aliases: ["package-id", "packageId", "id"], required: true },
        { name: "version", aliases: ["version"], type: "number" }
      ]
    ...
    cli: {
      command: ["knowledge-packages", "export"],
      usage: "knowledge-packages export --id PACKAGE_ID [--version N]",
      pathParams: { packageId: ["package-id", "packageId", "id"] }
    },
    requiredScopes: ["console:read"]
  },
  ...
  },
  {
    ...
    http: {
      ...
      coerce: { limit: "number", learningEnabled: "boolean", explain: "boolean" }
    },
    requiredScopes: ["knowledge:read"]
  },
  {
  ...
  {
    id: "agent_tools.search",
    feature: "agent_tools",
    label: "工具授权检索",
    target: { controller: "system", method: "handleAgentToolSearch" },
    http: {
      method: "GET",
      path: "/api/agent-tools/search",
      localInForwardMode: true,
      query: [
    ...
    cli: { command: ["agent-tools", "search"], usage: "agent-tools search --query QUERY [--header 'Authorization: Bearer ...']" }
  },
  {
    id: "agent_tools.storage_summary",
    feature: "agent_tools",
    label: "工具授权存储摘要",
    target: { controller: "system", method: "handleAgentToolStorageSummary" },
    http: { method: "GET", path: "/api/agent-tools/storage/summary", localInForwardMode: true },
    rpc: { method: "agent_tools.storage_summary" },
    cli: { command: ["agent-tools", "storage"], usage: "agent-tools storage --header 'Authorization: Bearer ...'" }
  },
  {
    id: "agent_tools.jobs",
    feature: "agent_tools",
    label: "工具授权任务列表",
    target: { controller: "system", method: "handleAgentToolJobs" },
    http: {
      method: "GET",
      path: "/api/agent-tools/jobs",
      localInForwardMode: true,
      query: [{ name: "limit", aliases: ["limit"] }]
    },
    rpc: {
      method: "agent_tools.jobs",
      query: [{ name: "limit", aliases: ["limit"] }]
    },
    cli: { command: ["agent-tools", "jobs"], usage: "agent-tools jobs [--limit 20] --header 'Authorization: Bearer ...'" }
  },
  {
    id: "agent_tools.job",
    feature: "agent_tools",
    label: "工具授权任务详情",
    target: { controller: "system", method: "handleAgentToolJob" },
    http: { method: "GET", path: "/api/agent-tools/jobs/:jobId", localInForwardMode: true },
    rpc: {
      method: "agent_tools.job",
      params: [{ name: "jobId", aliases: ["job-id", "id"], required: true }]
    },
    cli: {
      command: ["agent-tools", "job"],
      usage: "agent-tools job --id JOB_ID --header 'Authorization: Bearer ...'",
      pathParams: { jobId: ["job-id", "id"] }
    }
  },
  {
    id: "agent_tools.knowledge_affair_taxonomy",
    feature: "agent_tools",
    label: "工具授权事务分类增强",
    target: { controller: "system", method: "handleAgentToolEnhanceAffairTaxonomy" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/affair-taxonomy", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_affair_taxonomy", body: "params" },
    cli: { command: ["agent-tools", "knowledge"], usage: "agent-tools knowledge --body taxonomy.json --header 'Authorization: Bearer ...'" }
  },
  {
    id: "agent_tools.knowledge_console",
    feature: "agent_tools",
    label: "工具授权知识库控制台状态",
    target: { controller: "system", method: "handleAgentToolKnowledgeConsole" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/console", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_console" }
  },
  {
    id: "agent_tools.knowledge_config_schema",
    feature: "agent_tools",
    label: "工具授权知识库配置表单",
    target: { controller: "system", method: "handleAgentToolKnowledgeConfigSchema" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/config-schema", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_config_schema" }
  },
  {
    id: "agent_tools.knowledge_capabilities",
    feature: "agent_tools",
    label: "工具授权知识库协议能力",
    target: { controller: "system", method: "handleAgentToolKnowledgeCapabilities" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/capabilities", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_capabilities" }
  },
  {
    id: "agent_tools.knowledge_health",
    feature: "agent_tools",
    label: "工具授权知识库健康状态",
    target: { controller: "system", method: "handleAgentToolKnowledgeHealth" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/health", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_health" }
  },
  {
    id: "agent_tools.knowledge_maintenance_get",
    feature: "agent_tools",
    label: "工具授权读取知识库维护参数",
    target: { controller: "system", method: "handleAgentToolKnowledgeMaintenanceGet" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/maintenance", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_maintenance_get" }
  },
  {
    id: "agent_tools.knowledge_maintenance_set",
    feature: "agent_tools",
    label: "工具授权设置知识库维护参数",
    target: { controller: "system", method: "handleAgentToolKnowledgeMaintenanceSet" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/maintenance", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_maintenance_set", body: "params" }
  },
  {
    id: "agent_tools.knowledge_reindex",
    feature: "agent_tools",
    label: "工具授权重建知识库索引",
    target: { controller: "system", method: "handleAgentToolKnowledgeReindex" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/reindex", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_reindex", body: "params" }
  },
  {
    id: "agent_tools.knowledge_maintenance_run",
    feature: "agent_tools",
    label: "工具授权执行知识库维护任务",
    target: { controller: "system", method: "handleAgentToolKnowledgeMaintenanceRun" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/maintenance/run", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_maintenance_run", body: "params" }
  },
  {
    id: "agent_tools.knowledge_sync",
    feature: "agent_tools",
    label: "工具授权知识库增量同步",
    target: { controller: "system", method: "handleAgentToolKnowledgeSync" },
    http: {
      method: "GET",
      path: "/api/agent-tools/knowledge/sync",
      localInForwardMode: true,
      query: [
        { name: "since", aliases: ["since", "cursor"] },
        { name: "limit", aliases: ["limit"] },
    ...
    rpc: {
      method: "agent_tools.knowledge_sync",
      query: [
        { name: "since", aliases: ["since", "cursor"] },
        { name: "limit", aliases: ["limit"] },
        { name: "scope", aliases: ["scope"] }
  ...
  {
    id: "agent_tools.knowledge_changes",
    feature: "agent_tools",
    label: "工具授权提交结构化知识变更",
    target: { controller: "system", method: "handleAgentToolKnowledgeChanges" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/changes", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_changes", body: "params" }
  },
  {
    id: "agent_tools.knowledge_review_items",
    feature: "agent_tools",
    label: "工具授权知识审核列表",
    target: { controller: "system", method: "handleAgentToolKnowledgeReviewItems" },
    http: {
      method: "GET",
      path: "/api/agent-tools/knowledge/review-items",
      localInForwardMode: true,
      query: [
        { name: "status", aliases: ["status"] },
        { name: "limit", aliases: ["limit"] }
    ...
    rpc: {
      method: "agent_tools.knowledge_review_items",
      query: [
        { name: "status", aliases: ["status"] },
        { name: "limit", aliases: ["limit"] }
      ]
  ...
  {
    id: "agent_tools.knowledge_review_resolve",
    feature: "agent_tools",
    label: "工具授权解决知识审核项",
    target: { controller: "system", method: "handleAgentToolResolveKnowledgeReviewItem" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/review-items/:reviewId/resolve", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_review_resolve",
      body: "params",
      params: [{ name: "reviewId", aliases: ["review-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_feedback",
    feature: "agent_tools",
    label: "工具授权记录知识反馈",
    target: { controller: "system", method: "handleAgentToolKnowledgeFeedback" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/feedback", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_feedback", body: "params" }
  },
  {
    id: "agent_tools.knowledge_suggestions",
    feature: "agent_tools",
    label: "工具授权知识自进化建议列表",
    target: { controller: "system", method: "handleAgentToolKnowledgeSuggestions" },
    http: {
      method: "GET",
      path: "/api/agent-tools/knowledge/suggestions",
      localInForwardMode: true,
      query: [
        { name: "status", aliases: ["status"] },
        { name: "limit", aliases: ["limit"] }
    ...
    rpc: {
      method: "agent_tools.knowledge_suggestions",
      query: [
        { name: "status", aliases: ["status"] },
        { name: "limit", aliases: ["limit"] }
      ]
  ...
  {
    id: "agent_tools.knowledge_suggestion_resolve",
    feature: "agent_tools",
    label: "工具授权解决知识自进化建议",
    target: { controller: "system", method: "handleAgentToolResolveKnowledgeSuggestion" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/suggestions/:suggestionId/resolve", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_suggestion_resolve",
      body: "params",
      params: [{ name: "suggestionId", aliases: ["suggestion-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_learning_jobs",
    feature: "agent_tools",
    label: "工具授权执行知识学习任务",
    target: { controller: "system", method: "handleAgentToolKnowledgeLearningJob" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/learning/jobs", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_learning_jobs", body: "params" }
  },
  {
    id: "agent_tools.knowledge_learning_health",
    feature: "agent_tools",
    label: "工具授权知识学习健康状态",
    target: { controller: "system", method: "handleAgentToolKnowledgeLearningHealth" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/learning/health", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_learning_health" }
  },
  {
    id: "agent_tools.knowledge_evidence_gate_evaluate",
    feature: "agent_tools",
    label: "工具授权评估证据充分性",
    target: { controller: "system", method: "handleAgentToolEvidenceGateEvaluate" },
    safety: { risk: "read_only", requiresConfirmation: false },
    http: { method: "POST", path: "/api/agent-tools/knowledge/evidence-gate/evaluate", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_evidence_gate_evaluate", body: "params" }
  },
  {
    id: "agent_tools.knowledge_agent_skill",
    feature: "agent_tools",
    label: "工具授权读取知识库智能体技能",
    target: { controller: "system", method: "handleAgentToolKnowledgeAgentSkill" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/agent-skill", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_agent_skill" }
  },
  {
    id: "agent_tools.knowledge_agent_skill_plan",
    feature: "agent_tools",
    label: "工具授权规划知识库智能体查询",
    target: { controller: "system", method: "handleAgentToolKnowledgeAgentSkillPlan" },
    safety: { risk: "read_only", requiresConfirmation: false },
    http: { method: "POST", path: "/api/agent-tools/knowledge/agent-skill/plan", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_agent_skill_plan", body: "params" }
  },
  {
    id: "agent_tools.knowledge_agent_skill_run",
    feature: "agent_tools",
    label: "工具授权执行知识库智能体查询技能",
    target: { controller: "system", method: "handleAgentToolKnowledgeAgentSkillRun" },
    safety: { risk: "read_only", requiresConfirmation: false },
    http: { method: "POST", path: "/api/agent-tools/knowledge/agent-skill/run", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_agent_skill_run", body: "params" }
  },
  {
    id: "agent_tools.knowledge_skills_list",
    feature: "agent_tools",
    label: "工具授权知识 Skill 列表",
    target: { controller: "system", method: "handleAgentToolKnowledgeSkills" },
    http: {
      method: "GET",
      path: "/api/agent-tools/knowledge/skills",
      localInForwardMode: true,
      query: [
        { name: "status", aliases: ["status"] },
        { name: "query", aliases: ["query", "q"] },
    ...
    rpc: {
      method: "agent_tools.knowledge_skills_list",
      query: [
        { name: "status", aliases: ["status"] },
        { name: "query", aliases: ["query", "q"] },
        { name: "limit", aliases: ["limit"] }
  ...
  {
    id: "agent_tools.knowledge_skills_generate",
    feature: "agent_tools",
    label: "工具授权蒸馏知识 Skill",
    target: { controller: "system", method: "handleAgentToolKnowledgeSkillGenerate" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/skills/generate", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_skills_generate", body: "params" }
  },
  {
    id: "agent_tools.knowledge_skills_propose",
    feature: "agent_tools",
    label: "工具授权提交智能体知识 Skill 提案",
    target: { controller: "system", method: "handleAgentToolKnowledgeSkillPropose" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/skills/propose", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_skills_propose", body: "params" }
  },
  {
    id: "agent_tools.knowledge_skill_framework",
    feature: "agent_tools",
    label: "工具授权读取知识 Skill 框架",
    target: { controller: "system", method: "handleAgentToolKnowledgeSkillFramework" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/skill-framework", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_skill_framework" }
  },
  {
    id: "agent_tools.knowledge_skill_framework_save",
    feature: "agent_tools",
    label: "工具授权保存知识 Skill 框架",
    target: { controller: "system", method: "handleAgentToolSaveKnowledgeSkillFramework" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/skill-framework", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_skill_framework_save", body: "params" }
  },
  {
    id: "agent_tools.knowledge_golden_rules_list",
    feature: "agent_tools",
    label: "工具授权读取黄金规则包",
    target: { controller: "system", method: "handleAgentToolGoldenRules" },
    safety: { risk: "read_only", requiresConfirmation: false },
    http: { method: "GET", path: "/api/agent-tools/knowledge/golden-rules", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_golden_rules_list" }
  },
  {
    id: "agent_tools.knowledge_golden_rules_save",
    feature: "agent_tools",
    label: "工具授权保存黄金规则包",
    target: { controller: "system", method: "handleAgentToolSaveGoldenRules" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/golden-rules", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_golden_rules_save", body: "params" }
  },
  {
    id: "agent_tools.knowledge_golden_rules_publish",
    feature: "agent_tools",
    label: "工具授权发布黄金规则包",
    target: { controller: "system", method: "handleAgentToolPublishGoldenRules" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/golden-rules/:packageId/publish", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_golden_rules_publish",
      body: "params",
      params: [{ name: "packageId", aliases: ["package-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_golden_rules_rollback",
    feature: "agent_tools",
    label: "工具授权回滚黄金规则包",
    target: { controller: "system", method: "handleAgentToolRollbackGoldenRules" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/golden-rules/:packageId/rollback", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_golden_rules_rollback",
      body: "params",
      params: [{ name: "packageId", aliases: ["package-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_rule_authoring_chat",
    feature: "agent_tools",
    label: "工具授权对话生成黄金规则草稿",
    target: { controller: "system", method: "handleAgentToolKnowledgeRuleAuthoringChat" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/rule-authoring/chat", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_rule_authoring_chat", body: "params" }
  },
  {
    id: "agent_tools.knowledge_rule_authoring_run_get",
    feature: "agent_tools",
    label: "工具授权读取规则生成运行",
    target: { controller: "system", method: "handleAgentToolKnowledgeRuleAuthoringRunGet" },
    safety: { risk: "read_only", requiresConfirmation: false },
    http: { method: "GET", path: "/api/agent-tools/knowledge/rule-authoring/runs/:runId", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_rule_authoring_run_get",
      params: [{ name: "runId", aliases: ["run-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_gold_cases_list",
    feature: "agent_tools",
    label: "工具授权读取黄金样本",
    target: { controller: "system", method: "handleAgentToolGoldCases" },
    safety: { risk: "read_only", requiresConfirmation: false },
    http: {
      method: "GET",
      path: "/api/agent-tools/knowledge/gold-cases",
      localInForwardMode: true,
      query: [
        { name: "limit", aliases: ["limit"] },
        { name: "tag", aliases: ["tag"] }
    ...
    rpc: {
      method: "agent_tools.knowledge_gold_cases_list",
      query: [
        { name: "limit", aliases: ["limit"] },
        { name: "tag", aliases: ["tag"] }
      ]
  ...
  {
    id: "agent_tools.knowledge_gold_cases_save",
    feature: "agent_tools",
    label: "工具授权保存黄金样本",
    target: { controller: "system", method: "handleAgentToolSaveGoldCase" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/gold-cases", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_gold_cases_save", body: "params" }
  },
  {
    id: "agent_tools.knowledge_distillation_runs_create",
    feature: "agent_tools",
    label: "工具授权启动知识蒸馏运行",
    target: { controller: "system", method: "handleAgentToolKnowledgeDistillationRuns" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/distillation/runs", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_distillation_runs_create", body: "params" }
  },
  {
    id: "agent_tools.knowledge_distillation_runs_get",
    feature: "agent_tools",
    label: "工具授权读取知识蒸馏运行",
    target: { controller: "system", method: "handleAgentToolKnowledgeDistillationRunGet" },
    safety: { risk: "read_only", requiresConfirmation: false },
    http: { method: "GET", path: "/api/agent-tools/knowledge/distillation/runs/:runId", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_distillation_runs_get",
      params: [{ name: "runId", aliases: ["run-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_skill_evaluation_runs_create",
    feature: "agent_tools",
    label: "工具授权创建 SkillSet 离线评估",
    target: { controller: "system", method: "handleAgentToolKnowledgeSkillEvaluationRuns" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/skills/evaluation/runs", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_skill_evaluation_runs_create", body: "params" }
  },
  {
    id: "agent_tools.knowledge_skill_deployments_create",
    feature: "agent_tools",
    label: "工具授权发布 SkillSet 灰度部署",
    target: { controller: "system", method: "handleAgentToolKnowledgeSkillDeployments" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/skills/deployments", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_skill_deployments_create", body: "params" }
  },
  {
    id: "agent_tools.knowledge_skill_deployments_rollback",
    feature: "agent_tools",
    label: "工具授权回滚 SkillSet 部署",
    target: { controller: "system", method: "handleAgentToolKnowledgeSkillDeploymentRollback" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/skills/deployments/:deploymentId/rollback", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_skill_deployments_rollback",
      body: "params",
      params: [{ name: "deploymentId", aliases: ["deployment-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_training_sets_export",
    feature: "agent_tools",
    label: "工具授权导出黄金训练集",
    target: { controller: "system", method: "handleAgentToolKnowledgeTrainingSetExport" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/training-sets/export", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_training_sets_export", body: "params" }
  },
  {
    id: "agent_tools.knowledge_skills_get",
    feature: "agent_tools",
    label: "工具授权读取知识 Skill",
    target: { controller: "system", method: "handleAgentToolKnowledgeSkillGet" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/skills/:skillId", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_skills_get",
      params: [{ name: "skillId", aliases: ["skill-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_skills_resolve",
    feature: "agent_tools",
    label: "工具授权审核知识 Skill",
    target: { controller: "system", method: "handleAgentToolKnowledgeSkillResolve" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/skills/:skillId/resolve", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_skills_resolve",
      body: "params",
      params: [{ name: "skillId", aliases: ["skill-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_evaluation_runs_create",
    feature: "agent_tools",
    label: "工具授权创建智能体知识评估运行",
    target: { controller: "system", method: "handleAgentToolAgentEvaluationRuns" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/evaluation/runs", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_evaluation_runs_create", body: "params" }
  },
  {
    id: "agent_tools.knowledge_evaluation_runs_list",
    feature: "agent_tools",
    label: "工具授权列出智能体知识评估运行",
    target: { controller: "system", method: "handleAgentToolAgentEvaluationRunList" },
    http: {
      method: "GET",
      path: "/api/agent-tools/knowledge/evaluation/runs",
      localInForwardMode: true,
      query: [{ name: "limit", aliases: ["limit"] }],
      coerce: { limit: "number" }
    },
    rpc: {
      method: "agent_tools.knowledge_evaluation_runs_list",
      query: [{ name: "limit", aliases: ["limit"] }]
    }
  },
  {
    id: "agent_tools.knowledge_evaluation_runs_get",
    feature: "agent_tools",
    label: "工具授权读取智能体知识评估运行",
    target: { controller: "system", method: "handleAgentToolAgentEvaluationRun" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/evaluation/runs/:runId", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_evaluation_runs_get",
      params: [{ name: "runId", aliases: ["run-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_model_roles",
    feature: "agent_tools",
    label: "工具授权读取知识库模型角色",
    target: { controller: "system", method: "handleAgentToolModelDecisionRoles" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/model-roles", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_model_roles" }
  },
  {
    id: "agent_tools.knowledge_model_decision",
    feature: "agent_tools",
    label: "工具授权执行知识库模型决策",
    target: { controller: "system", method: "handleAgentToolModelDecisionDecide" },
    safety: { risk: "read_only", requiresConfirmation: false },
    http: { method: "POST", path: "/api/agent-tools/knowledge/model-roles/decide", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_model_decision", body: "params" }
  },
  {
    id: "agent_tools.knowledge_evolution_describe",
    feature: "agent_tools",
    label: "工具授权读取知识进化闭环说明",
    target: { controller: "system", method: "handleAgentToolKnowledgeEvolutionDescribe" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/evolution", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_evolution_describe" }
  },
  {
    id: "agent_tools.knowledge_evolution_runs_create",
    feature: "agent_tools",
    label: "工具授权执行知识进化闭环",
    target: { controller: "system", method: "handleAgentToolKnowledgeEvolutionRun" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/evolution/runs", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_evolution_runs_create", body: "params" }
  },
  {
    id: "agent_tools.knowledge_evolution_runs_list",
    feature: "agent_tools",
    label: "工具授权列出知识进化闭环运行",
    target: { controller: "system", method: "handleAgentToolKnowledgeEvolutionRuns" },
    http: {
      method: "GET",
      path: "/api/agent-tools/knowledge/evolution/runs",
      localInForwardMode: true,
      query: [{ name: "limit", aliases: ["limit"] }],
      coerce: { limit: "number" }
    },
    rpc: {
      method: "agent_tools.knowledge_evolution_runs_list",
      query: [{ name: "limit", aliases: ["limit"] }]
    }
  },
  {
    id: "agent_tools.knowledge_evolution_runs_get",
    feature: "agent_tools",
    label: "工具授权读取知识进化闭环运行",
    target: { controller: "system", method: "handleAgentToolKnowledgeEvolutionRunGet" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/evolution/runs/:runId", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_evolution_runs_get",
      params: [{ name: "runId", aliases: ["run-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_hierarchy_audit",
    feature: "agent_tools",
    label: "工具授权审计分层索引质量",
    target: { controller: "system", method: "handleAgentToolKnowledgeHierarchyAudit" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/hierarchy/audit", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_hierarchy_audit", body: "params" }
  },
  {
    id: "agent_tools.knowledge_evolution_deployments_list",
    feature: "agent_tools",
    label: "工具授权列出检索 profile 部署",
    target: { controller: "system", method: "handleAgentToolKnowledgeEvolutionDeployments" },
    http: {
      method: "GET",
      path: "/api/agent-tools/knowledge/evolution/deployments",
      localInForwardMode: true,
      query: [
        { name: "status", aliases: ["status"] },
        { name: "limit", aliases: ["limit"] }
    ...
    rpc: {
      method: "agent_tools.knowledge_evolution_deployments_list",
      query: [
        { name: "status", aliases: ["status"] },
        { name: "limit", aliases: ["limit"] }
      ]
  ...
  {
    id: "agent_tools.knowledge_evolution_deployments_promote",
    feature: "agent_tools",
    label: "工具授权提升检索 profile 灰度部署",
    target: { controller: "system", method: "handleAgentToolKnowledgeEvolutionDeploymentPromote" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/evolution/deployments/:deploymentId/promote", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_evolution_deployments_promote",
      body: "params",
      params: [{ name: "deploymentId", aliases: ["deployment-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_evolution_deployments_rollback",
    feature: "agent_tools",
    label: "工具授权回滚检索 profile 部署",
    target: { controller: "system", method: "handleAgentToolKnowledgeEvolutionDeploymentRollback" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/evolution/deployments/:deploymentId/rollback", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_evolution_deployments_rollback",
      body: "params",
      params: [{ name: "deploymentId", aliases: ["deployment-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.context_profiles_get",
    feature: "agent_tools",
    label: "工具授权读取上下文预算 profile",
    target: { controller: "system", method: "handleAgentToolContextProfiles" },
    http: { method: "GET", path: "/api/agent-tools/context/profiles", localInForwardMode: true },
    rpc: { method: "agent_tools.context_profiles_get" }
  },
  {
    id: "agent_tools.context_profiles_set",
    feature: "agent_tools",
    label: "工具授权保存上下文预算 profile",
    target: { controller: "system", method: "handleAgentToolContextProfiles" },
    http: { method: "POST", path: "/api/agent-tools/context/profiles", localInForwardMode: true },
    rpc: { method: "agent_tools.context_profiles_set", body: "params" }
  },
  {
    id: "agent_tools.agent_workspaces",
    feature: "agent_tools",
    label: "工具授权列出智能体共享工作空间",
    target: { controller: "system", method: "handleAgentToolAgentWorkspaces" },
    http: {
      method: "GET",
      path: "/api/agent-tools/agent-workspaces",
      localInForwardMode: true,
      query: [
        { name: "status", aliases: ["status"] },
        { name: "limit", aliases: ["limit"] },
    ...
    rpc: {
      method: "agent_tools.agent_workspaces",
      query: [
        { name: "status", aliases: ["status"] },
        { name: "limit", aliases: ["limit"] },
        { name: "includeSummary", aliases: ["include-summary", "includeSummary"] }
  ...
  {
    id: "agent_tools.agent_workspace",
    feature: "agent_tools",
    label: "工具授权读取智能体共享工作空间",
    target: { controller: "system", method: "handleAgentToolAgentWorkspace" },
    http: {
      method: "GET",
      path: "/api/agent-tools/agent-workspaces/:workspaceId",
      localInForwardMode: true,
      query: [{ name: "includePrivate", aliases: ["include-private", "includePrivate", "private"] }],
      coerce: { includePrivate: "boolean" }
    },
    rpc: {
      method: "agent_tools.agent_workspace",
      params: [{ name: "workspaceId", aliases: ["workspace-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.agent_workspace_submission_resolve",
    feature: "agent_tools",
    label: "工具授权审核智能体共享提交",
    target: { controller: "system", method: "handleAgentToolResolveAgentWorkspaceSubmission" },
    http: { method: "POST", path: "/api/agent-tools/agent-workspaces/:workspaceId/submissions/:submissionId/resolve", localInForwardMode: true },
    rpc: {
      method: "agent_tools.agent_workspace_submission_resolve",
      body: "params",
      params: [
        { name: "workspaceId", aliases: ["workspace-id", "workspaceId"], required: true },
        { name: "submissionId", aliases: ["submission-id", "submissionId", "id"], required: true }
  ...
  {
    id: "agent_tools.agent_workspace_issue_resolve",
    feature: "agent_tools",
    label: "工具授权解决智能体共享空间 issue",
    target: { controller: "system", method: "handleAgentToolResolveAgentWorkspaceIssue" },
    http: { method: "POST", path: "/api/agent-tools/agent-workspaces/:workspaceId/issues/:issueId/resolve", localInForwardMode: true },
    rpc: {
      method: "agent_tools.agent_workspace_issue_resolve",
      body: "params",
      params: [
        { name: "workspaceId", aliases: ["workspace-id", "workspaceId"], required: true },
        { name: "issueId", aliases: ["issue-id", "issueId", "id"], required: true }
  ...
  {
    id: "agent_tools.agent_workspace_locks",
    feature: "agent_tools",
    label: "工具授权列出智能体共享空间锁",
    target: { controller: "system", method: "handleAgentToolAgentWorkspaceLocks" },
    http: {
      method: "GET",
      path: "/api/agent-tools/agent-workspaces/:workspaceId/locks",
      localInForwardMode: true,
      query: [
        { name: "limit", aliases: ["limit"] },
        { name: "includeExpired", aliases: ["include-expired", "includeExpired"] }
    ...
    rpc: {
      method: "agent_tools.agent_workspace_locks",
      params: [{ name: "workspaceId", aliases: ["workspace-id", "workspaceId", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.agent_workspace_lock",
    feature: "agent_tools",
    label: "工具授权获取或释放智能体共享空间锁",
    target: { controller: "system", method: "handleAgentToolAgentWorkspaceLock" },
    http: { method: "POST", path: "/api/agent-tools/agent-workspaces/:workspaceId/locks", localInForwardMode: true },
    rpc: {
      method: "agent_tools.agent_workspace_lock",
      body: "params",
      params: [{ name: "workspaceId", aliases: ["workspace-id", "workspaceId", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_summarization_runs_create",
    feature: "agent_tools",
    label: "工具授权创建多智能体知识总结任务",
    target: { controller: "system", method: "handleAgentToolKnowledgeSummarizationRun" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/summarization/runs", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_summarization_runs_create", body: "params" }
  },
  {
    id: "agent_tools.knowledge_summarization_runs_get",
    feature: "agent_tools",
    label: "工具授权读取多智能体知识总结任务",
    target: { controller: "system", method: "handleAgentToolGetKnowledgeSummarizationRun" },
    http: {
      method: "GET",
      path: "/api/agent-tools/knowledge/summarization/runs/:runId",
      localInForwardMode: true,
      query: [{ name: "includePrivate", aliases: ["include-private", "includePrivate", "private"] }],
      coerce: { includePrivate: "boolean" }
    },
    rpc: {
      method: "agent_tools.knowledge_summarization_runs_get",
      params: [{ name: "runId", aliases: ["run-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_summarization_runs_approve",
    feature: "agent_tools",
    label: "工具授权确认多智能体知识总结 artifact",
    target: { controller: "system", method: "handleAgentToolApproveKnowledgeSummarizationRun" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/summarization/runs/:runId/approve", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_summarization_runs_approve",
      body: "params",
      params: [{ name: "runId", aliases: ["run-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_search",
    feature: "agent_tools",
    label: "工具授权知识库统一检索",
    target: { controller: "system", method: "handleAgentToolKnowledgeSearch" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/search", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_search", body: "params" }
  },
  {
    id: "agent_tools.knowledge_search_get",
    feature: "agent_tools",
    label: "工具授权知识库统一检索 GET",
    target: { controller: "system", method: "handleAgentToolKnowledgeSearch" },
    http: {
      method: "GET",
      path: "/api/agent-tools/knowledge/search",
      localInForwardMode: true,
      query: [
        { name: "query", aliases: ["query", "q"] },
        { name: "limit", aliases: ["limit"] },
    ...
    rpc: {
      method: "agent_tools.knowledge_search_get",
      query: [
        { name: "query", aliases: ["query", "q"] },
        { name: "limit", aliases: ["limit"] },
        { name: "batchId", aliases: ["batch-id", "batchId"] },
  ...
  {
    id: "agent_tools.knowledge_item",
    feature: "agent_tools",
    label: "工具授权知识对象详情",
    target: { controller: "system", method: "handleAgentToolGetKnowledgeItem" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/items/:itemId", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_item",
      params: [{ name: "itemId", aliases: ["item-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_evidence",
    feature: "agent_tools",
    label: "工具授权知识证据详情",
    target: { controller: "system", method: "handleAgentToolGetKnowledgeEvidence" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/evidence/:evidenceId", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_evidence",
      params: [{ name: "evidenceId", aliases: ["evidence-id", "id"], required: true }]
    }
  },
  {
    id: "agent_tools.knowledge_asset",
    feature: "agent_tools",
    label: "工具授权知识资产读取",
    target: { controller: "system", method: "handleAgentToolGetKnowledgeAsset" },
    http: { method: "GET", path: "/api/agent-tools/knowledge/assets/:assetId", localInForwardMode: true },
    rpc: {
      method: "agent_tools.knowledge_asset",
      params: [{ name: "assetId", aliases: ["asset-id", "id"], required: true }]
    },
    binary: true
  },
  {
    id: "agent_tools.knowledge_render_markdown",
    feature: "agent_tools",
    label: "工具授权知识证据 Markdown 输出",
    target: { controller: "system", method: "handleAgentToolRenderKnowledgeMarkdown" },
    http: { method: "POST", path: "/api/agent-tools/knowledge/render/markdown", localInForwardMode: true },
    rpc: { method: "agent_tools.knowledge_render_markdown", body: "params" }
  },
  {
    id: "agent_tools.knowledge_graph",
    feature: "agent_tools",
    label: "工具授权知识局部图谱",
    target: { controller: "system", method: "handleAgentToolKnowledgeGraph" },
    http: {
      method: "GET",
      path: "/api/agent-tools/knowledge/graph",
      localInForwardMode: true,
      query: [
        { name: "seed", aliases: ["seed", "id"] },
        { name: "depth", aliases: ["depth"] },
      ...
      coerce: { depth: "number", limit: "number" }
    },
    rpc: {
      method: "agent_tools.knowledge_graph",
      query: [
        { name: "seed", aliases: ["seed", "id"] },
        { name: "depth", aliases: ["depth"] },
        { name: "limit", aliases: ["limit"] }
